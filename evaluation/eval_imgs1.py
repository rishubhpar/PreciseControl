...
from evaluation.base_class1 import IDCLIPScoreCalculator
...
if __name__ == "__main__":
    ...
    parser.add_argument("--eval_folder", type=str, default="../IP-Adapter/benchmark_ravdess/IP_adapter_face_plus_cfg1.2") # ./benchmark_results/ours_lora2
    ...
    if(not plot_values):
        id_score_calculator = IDCLIPScoreCalculator(
            ...
            in_image_paths_file= './aug_images/ravdess_comparision_data/edited',
        )
