...
sys.path.append(".")
sys.path.append("..")
sys.path.append("/mnt/data/rishubh/sachi/CelebBasis_pstar_sd2/src/taming-transformers")
...
from evaluation.base_class_dino import IDCLIPScoreCalculator
from evaluation.dino_eval import IdCLIPEvaluator
...
if __name__ == "__main__":
    ...
    parser.add_argument("--eval_folder", type=str, default="/mnt/data/rishubh/sachi/CelebBasis_pstar_sd2/benchmark_results15/syn/ours_lora02_50it") # ./benchmark_results/ours_lora2
    parser.add_argument("--eval_out_dir", type=str, default="./exp_eval/ours/")
    parser.add_argument("--eval_project_folder", type=str, default="2023-05-05T18-42-56_two_person-sdv4") # ../IP-Adapter/benchmark_ravdess/IP_adapter_face_plus_cfg1.5"
    parser.add_argument("--num_of_img_per_prompt", type=int, default=1)
    parser.add_argument("--prompt_file", type=str, default="./infer_images/comparison_prompt.txt")
    ...
    if(not plot_values):
        id_score_calculator = IDCLIPScoreCalculator(
            ...
            in_image_paths_file= './aug_images/syn_comparision_data/edited',
        )
