...
class DDIMSampler(object):
    ...
    def ddim_sampling(self, cond, shape,
                      ...
                      unconditional_guidance_scale=1., unconditional_conditioning=None,image_for_ddim=None, use_prompt_mixing=False):
        ...
        for i, step in enumerate(iterator):
            ...
            if(self.model.embedding_manager.use_hspace == True):
                h_space_feature = self.model.apply_model(img, ts, uc, return_hspace=True)
            else:
            ...
            if(use_prompt_mixing and i < steps_for_prompt_mixing):
                prompt_mixing = image_for_ddim['prompt_mixing_prompt']
                # print("prompt mixing")
                c = prompt_mixing
            ...
            # plt.bar(np.arange(len(pca_coeff)), pca_coeff)
            # plt.savefig(f"./pca_coeff/pca_coeff_{i}.png")
            ...
            del h_space, h_space_feature, face_img, img_ori, aligned_faces, ts, c, cond, outs, pred_x0
