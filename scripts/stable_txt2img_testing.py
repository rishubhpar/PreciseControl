...
def main():
    ...
    if config.model.params.personalization_config.params.test_mode == "image":
        ...
        if opt.eval_dataset in ('vgg0', 'vgg1'):
            ...
            test_id2 = 0
            # id1 = Image.open("./aug_images/stylegan3/edited/{}".format(
            #     os.listdir("./aug_images/stylegan3/edited/")[opt.eval_id1])).convert("RGB")
            # id2 = Image.open("./aug_images/stylegan3/edited/{}".format(
            #     os.listdir("./aug_images/stylegan3/edited/")[test_id2])).convert("RGB")
            # id1 = Image.open("./aug_images/comparision/edited/{}".format(
            #     os.listdir("./aug_images/comparision/edited/")[opt.eval_id1])).convert("RGB")
            # id2 = Image.open("./aug_images/comparision/edited/{}".format(
            #     os.listdir("./aug_images/comparision/edited/")[test_id2])).convert("RGB")
    ...
    # delta_w_dict = json.load(open("./latent_directions_flame.json"))
    ...
    # with open("./sketch_latents/sketch4_latents.json", "r") as f:
    #     w_latent = json.load(f)
    #     w_latent = torch.tensor(w_latent, device=device).repeat(batch_size, 1, 1)
    ...
    files_list = sorted(os.listdir("./aug_images/{}/edited/".format(img_folder_name)))
    ...
    for l, img in enumerate(files_list):
        if(img.endswith(".jpg") or img.endswith(".png") or img.endswith(".jpeg")):
            img = opt.file_name
            id1 = Image.open("./aug_images/{}/edited/{}".format(img_folder_name, img)).convert("RGB")
            faces = pil_to_4d(id1)
