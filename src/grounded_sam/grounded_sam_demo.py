...
def main(pil_img=None):
    ...
    # load image
    # if pil_img is not a numpy array
    ...
    json_data = save_mask_data(output_dir, masks, boxes_filt, pred_phrases)
...
def load_image(image_path):
    ...
    print("shape of image: ", np.array(image_pil).shape)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_image", type=str, required=False, default="./demo_img3.jpg", help="path to image file")
    parser.add_argument("--text_prompt", type=str, required=False, default="person", help="text prompt")
    parser.add_argument(
        "--output_dir", "-o", type=str, default="output_dir", required=False, help="output directory"
    )
